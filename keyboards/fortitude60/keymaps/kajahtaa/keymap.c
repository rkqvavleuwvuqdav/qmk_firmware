 ...
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               |  Alt |  GUI |Lower |Enter |      |Space |Space |Raise |  RGUI|  ALT |
 *               `---------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, _______, _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT_RSFT_ENT , \
                 KC_LALT, LCMD_RIGHT,   LOWER,  KC_ENT, KC_SPC,  KC_SPC, KC_SPC, RAISE,    RCMD_LEFT, RALT_DOWN\
),
...
[_karjalasta] = LAYOUT( \
  ...
  KC_NO,  KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,                   KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_BSPC, \
  KC_NO,  KC_A,    KC_O,    KC_E,    KC_U,    KC_I,                   KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_SLSH, \
  KC_NO, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X, KC_NO, KC_NO, KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO , \
