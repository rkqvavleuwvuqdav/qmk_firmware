...
[_QWERTY] = LAYOUT_ortho_5x12( \
  ...
  MO(_RAISE), KC_LCTL, KC_LALT, KC_LGUI,   MO(_ME), KC_SPC,  KC_SPC,  MO(_LOWER),   KC_LGUI, KC_RALT, KC_LCTL,   KC_ENT  \
),
...
[_ME] = LAYOUT_ortho_5x12( \
  ...
  KC_TAB,  KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,    KC_F,    KC_LBRC,    KC_RBRC,    KC_MINS,    KC_EQL,    KC_PIPE,  \
...
[_LOWER] = LAYOUT_ortho_5x12( \
  ...
  KC_TRNS, KC_MUTE, _______,   KC_HOME, KC_END,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,  \
  KC_TRNS,  KC_VOLU, KC_SLCK,   KC_RBRC, KC_RBRC,   _______,   _______,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
  _______, KC_VOLD, KC_PAUS,   KC_MINS, KC_EQL,  _______,  _______,S(KC_NUHS),S(KC_NUBS),KC_HOME, KC_END, _______, \
...
[_RAISE] = LAYOUT_ortho_5x12( \
  ...
  _______,  _______, _______, _______, _______, _______, _______, _______,    KC_8,    KC_9,    KC_0,    KC_DEL,  \
  _______,  _______,   _______,   _______,   _______,   RESET,   _______,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
