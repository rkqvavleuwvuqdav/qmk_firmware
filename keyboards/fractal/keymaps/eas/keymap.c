 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  |      | TGme |    Space    |TGlwr |      | INS  | BSLH |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_5x12( \
  ...
  KC_LCTL, KC_LALT, KC_LGUI, _______,   TG(_ME), KC_SPC,  KC_SPC,  TG(_LOWER),   _______, KC_INS, KC_BSLS,   KC_ENT  \
),
...
[_LOWER] = LAYOUT_ortho_5x12( \
  ...
  KC_TILD, KC_MUTE, _______,   KC_HOME, KC_END,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,  \
  KC_DEL,  KC_VOLU, KC_SLCK,   KC_RBRC, KC_RBRC,   _______,   _______,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
...
[_RAISE] = LAYOUT_ortho_5x12( \
  ...
  KC_GRV,  _______, _______, _______, _______, _______, _______, _______,    KC_8,    KC_9,    KC_0,    KC_DEL,  \
